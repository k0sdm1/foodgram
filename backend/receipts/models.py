...
class Receipt(models.Model):
    ...
    cooking_time = models.PositiveSmallIntegerField(
        ...
        validators=(
            MinValueValidator(
                MIN_COOKING_TIME, f"Значение должно быть ≥ {MIN_COOKING_TIME}"
            ),
            MaxValueValidator(
                MAX_COOKING_TIME, f"Значение должно быть ≤ {MAX_COOKING_TIME}"
            ),
        ),
    )
    ...
    amount = models.PositiveSmallIntegerField(
        ...
        validators=(
            MinValueValidator(
                ...
                f"Значение должно быть ≥ {MIN_INGREDIENT_AMOUNT}",
            ),
            MaxValueValidator(
                MAX_INGREDIENT_AMOUNT,
                f"Значение должно быть ≤ {MAX_INGREDIENT_AMOUNT}",
            ),
        ),
    )
    ...
    class Meta:
        constraints = (
            ...
            models.CheckConstraint(
                check=~Q(user=F("following")), name="user_following_not_same"
            ),
        )
